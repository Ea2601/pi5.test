...
const buttonStyles = {
  ...
  sizes: {
    sm: 'px-3 py-2 text-sm h-9 min-w-[2.25rem] gap-1.5',
    md: 'px-4 py-3 text-base h-12 min-w-[3rem] gap-2',
    lg: 'px-6 py-4 text-lg h-14 min-w-[3.5rem] gap-2.5'
  }
};
  ...
  ({ 
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-600/0 via-emerald-400/0 to-emerald-600/0 opacity-0 hover:opacity-20 transition-opacity duration-300 rounded-2xl" />
